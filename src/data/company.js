...
export const company = {
  ...
  contact: {
    phone1: '+254 722 510 575',
    phone1Bare: '+254722510575',
    phone2: '+254 711 577 251',
    phone2Bare: '+254711577251',
    // WhatsApp number verified from Facebook post (0729-003-333)
    whatsapp: '+254 729 003 333',
    whatsappBare: '+254729003333',
  ...
  location: {
    ...
    city: 'Nairobi',
    country: 'Kenya',
    poBox: 'P.O. Box 23551-00625, Nairobi',
    // Coordinates verified via nairobi.tel listing
    lat: -1.2161388,
    lng: 36.8340376,
    googleMapsUrl: 'https://maps.google.com/?q=-1.2161388,36.8340376',
    directions:
  ...
  // ── Brand hashtags (verified from Facebook posts) ─────────────────────────
  hashtags: ['#DriveRiriCars', '#WhereExcellenceMeetsAffordability', '#MovingForwardTogether', '#CarsYouCanTrust'],
}
