import { MdFavorite, MdFavoriteBorder, MdSpeed, MdLocalGasStation, MdSettings } from 'react-icons/md'
  ...
  return (
    <article className="card-base group rounded overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        {/* Title */}
        <h3 className="font-bold text-dark text-base leading-tight mb-1">
          {car.year} {car.make} {car.model}
        </h3>
        <p className="text-muted text-xs mb-3 font-medium">{car.color}</p>
